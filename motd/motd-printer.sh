...
echo "$(tput setaf 5)HP-Deskjet:

  ,----,------------------------------,------.$(tput setaf 7)                    > Hostname ..... $Hostname$(tput setaf 5)
  | ## |                              |    - |$(tput setaf 7)                    > IP-Address ... $IP$(tput setaf 5)
  | ## |                              |    - |$(tput setaf 7)                    > Uptime ....... $UpTime$(tput setaf 5)
  |    |------------------------------|    - |$(tput setaf 7)                    > CPU-Temp ..... $CPUTempM°C$(tput setaf 5)
  |    ||............................||      |$(tput setaf 7)                    > Disk Usage ... $Root1 / $Root2$(tput setaf 5)
  |    ||,-                        -.||      |$(tput setaf 7)                    > Memory ....... $Memory1 / $Memory2$(tput setaf 5)
  |    ||___                      ___||    ##|
  |    ||--------------------------||        |
