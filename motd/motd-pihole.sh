 ...
 #######
   ########    %%%%
     ####### %%%%%
         (##%%%$(tput setaf 1)
        ,###%%%%
      ######%%%%%##$(tput setaf 15)       > Hostname ..... $Hostname$(tput setaf 1)
   ,#%%#####%%%%%####$(tput setaf 15)     > IP-Address ... $IP$(tput setaf 1)
  %%%%%%%%     ########$(tput setaf 15)   > Uptime ....... $UpTime$(tput setaf 1)
 #######%%     %%%%#####$(tput setaf 15)  > CPU-Temp ..... $CPUTempM°C$(tput setaf 1)
  (###### %%%## %%%%%%%$(tput setaf 15)   > Disk Usage ... $Root1 / $Root2$(tput setaf 1)
     ###%%%%%#######$(tput setaf 15)      > Memory ....... $Memory1 / $Memory2$(tput setaf 1)
       #%%%%%#####
          %%%##$(tput setaf 8)
